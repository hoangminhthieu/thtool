...
print (Colorate.Diagonal(Colors.blue_to_purple, "Nhập 1 để vô tool golike tiktok adb"))
print (Colorate.Diagonal(Colors.blue_to_purple, "Nhập 2 để vô tool ttc fb"))
